...
# Windows: python3 .\generate.py -f ..\redesk\flutter\build\windows\runner\Debug\ -o . -e ..\redesk\flutter\build\windows\runner\Debug\redesk.exe
...
if __name__ == '__main__':
    ...
    parser.add_option("-e", "--executable", dest="executable",
                      help="specify startup file in --folder, default is redesk.exe")
